...
## Project Structure
    ...
    ├── delicate_butterfly_30104  # Django project configurations
...
1. Clone this repo and `cd delicate_butterfly_30104`
...
2. Clone this repo and `cd delicate_butterfly_30104`
